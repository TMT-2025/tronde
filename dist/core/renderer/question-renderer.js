...
import { renderParagraphToXml } from "./content-renderer.js";
export function renderQuestionStem(question, displayIndex, profile) {
    ...
    const firstPXml = renderParagraphToXml({ ...firstP, runs }, {
...
export function renderQuestion(question, displayIndex, profile) {
