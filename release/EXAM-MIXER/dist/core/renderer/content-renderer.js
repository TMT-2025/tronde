...
export function renderRunToXml(run, options = {}) {
    if (run.isTab) {
...
export function renderTabsToXml(tabStops) {
...
export function renderParagraphToXml(paragraph, options = {}) {
    const pPrParts = [];
...
export function renderRichContentToXml(content, options = {}) {
